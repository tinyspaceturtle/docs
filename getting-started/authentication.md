...
Learn how to authenticate with the HeroBrain API using API keys.

---

## Getting Your API Key

1. Sign up at [app.herobrain.dev](https://app.herobrain.dev)
...
```bash
HEROBRAIN_API_KEY=tb_your_key_here
```
...
client = HeroBrain(api_key=os.getenv('HEROBRAIN_API_KEY'))
```
